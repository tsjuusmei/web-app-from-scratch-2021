...
},{}],"js/utils/helpers/appends.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.randomPhoto = randomPhoto;
exports.averageTemperature = averageTemperature;
exports.appendTemp = appendTemp;
...
},{}],"js/utils/helpers/fetches.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tempData = exports.photoData = void 0;

var _appends = require("../helpers/appends");
...
var photoData = fetch(photosUrl).then(function (response) {
  ...
  (0, _appends.randomPhoto)(data.photos);
});
exports.photoData = photoData;
var tempData = fetch(tempsUrl).then(function (res) {
  return res.json();
}).then(function (d) {
  return (0, _appends.averageTemperature)(d);
});
exports.tempData = tempData;
},{"../helpers/appends":"js/utils/helpers/appends.js"}],"js/utils/routes/router.js":[function(require,module,exports) {
"use strict";
...
var _fetches = require("../helpers/fetches");
...
var root = null;
var router = new _navigo.default(root, false);
...
},{"navigo":"../node_modules/navigo/lib/navigo.min.js","../helpers/fetches":"js/utils/helpers/fetches.js","../helpers/appends":"js/utils/helpers/appends.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
init();
},{"./utils/routes/router":"js/utils/routes/router.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
